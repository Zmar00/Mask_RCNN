...
NAME_OF_PROJECT = "electric_engine"
AREAS_OF_INTEREST_NAMES = ["screw","cover","poltopf","gear","gearbox","drivesnail","brushholder","anker","screwdriver","pickbox","roundmarker","toolbox","squaremarker"]
